...
const FormEditShippingAddress = () => {
    ...
    // to get the shipping address information
    useEffect(() => {
        axios
            .get(
    ...
    // to insert and update the shipping address information
    const handleSubmit = (event) => {
        ...
        if (formValues.id === 0) {
            ...
            axios
                .post(`${baseUrl}/${baseAuthUrl}/shippingaddressupsert`, data, {
                    headers: {
                        'Content-Type': 'application/json;charset=UTF-8',
                        'Access-Control-Allow-Origin': '*',
                    },
    ...
    return (
        <Form
            className="ps-form--edit-shipping-address"
