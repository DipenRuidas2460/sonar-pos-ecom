    ...
    <div className="ps-vendor-dashboard">
        <div className="container">
            <div className="ps-section__header">
                ...
                <p>
                    Designed base on WC Vendor Plugin. Sonar POS Ecommerce also
                    fully comptatiable with other popular plugins as Dokan,
                    YITH, etc .Can help you turns your site into multi-vendor
                    eCommerce site.
                </p>
            </div>
