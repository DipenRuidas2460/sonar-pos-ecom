                ...
                <div className="row">
                    <div className="col-xl-4 col-lg-4 col-md-4 col-sm-6 col-12 ">
                        <div className="ps-block--contact-info">
                            ...
                            <p>
                                <a href="mailto:contact@Sonar POS Ecommerce.com">
                                    contact@Sonar POS Ecommerce.com
                                </a>
                    ...
                    <div className="col-xl-4 col-lg-4 col-md-4 col-sm-6 col-12 ">
                        <div className="ps-block--contact-info">
                            ...
                            <p>
                                ...
                                <a href="#">career@Sonar POS Ecommerce.com</a>
                            </p>
                        </div>
                    </div>
                    <div className="col-xl-4 col-lg-4 col-md-4 col-sm-6 col-12 ">
                        <div className="ps-block--contact-info">
                            ...
                            <p>
                                <a href="#">
                                    customercare@Sonar POS Ecommerce.com
                                </a>
                    ...
                    <div className="col-xl-4 col-lg-4 col-md-4 col-sm-6 col-12 ">
                        <div className="ps-block--contact-info">
                            ...
                            <p>
                                <a href="#">media@Sonar POS Ecommerce.com</a>
                    ...
                    <div className="col-xl-4 col-lg-4 col-md-4 col-sm-6 col-12 ">
                        <div className="ps-block--contact-info">
                            ...
                            <p>
                                <a href="#">
                                    vendorsupport@Sonar POS Ecommerce.com
                                </a>
