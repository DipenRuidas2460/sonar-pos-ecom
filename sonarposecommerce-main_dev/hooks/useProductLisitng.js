                            ...
                            <LazyLoad>
                                ...
                                style={{ height:'156px' }}
                                 onError={(e) => {
                                    ...
                                    e.target.src =noimage ;// "../../static/img/noimage.png" ;
                                }}
                                 />
                            </LazyLoad>
                        </>
            ...
            if (payload.sale_price) {
                view = (
                    <p className="ps-product__price sale">
                        <span>$</span>
                        {formatCurrency(payload.UnitPrice)}
                        <del className="ml-2">
                            <span>$</span>
                            {formatCurrency(payload.UnitPrice)}
                        </del>
        ...
        title: (payload) => {
            let view = (
                <Link
                    ...
                    as={`/product/boxed/${payload.ItemID}`}>
                    <a className="ps-product__title">{payload.VariationName? payload.VariationName : payload.ItemName}</a>
                </Link>
            );
            return view;
        },
